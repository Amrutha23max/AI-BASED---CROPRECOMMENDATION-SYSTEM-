...
**1. Farmer Input:** Starting point where farmer provides soil details.

**2. Upload Soil Image:** User uploads soil image.
...
**6. Map Soil Values:** Converts soil into N, P, K, pH.
